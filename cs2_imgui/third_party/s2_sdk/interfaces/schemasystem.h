...
public:
    ...
    {
        typedef CSchemaClassInfo *(__thiscall *CallVFunctionFn)(void *, const char *);
        return get_v_func<CallVFunctionFn>(this, 2)(this, class_name);
    }

    CSchemaEnumBinding *FindDeclaredEnum(const char *name)
    {
        typedef CSchemaEnumBinding *(__thiscall *CallVFunctionFn)(void *, const char *);
        return get_v_func<CallVFunctionFn>(this, 3)(this, name);
    }

    CSchemaType *FindSchemaTypeByName(const char *name, std::uintptr_t *schema)
    {
        typedef CSchemaType *(__thiscall *CallVFunctionFn)(void *, const char *, std::uintptr_t*);
        return get_v_func<CallVFunctionFn>(this, 4)(this, name, schema);
    }

    CSchemaType *FindTypeDeclaredClass(const char *name)
    {
        typedef CSchemaType *(__thiscall *CallVFunctionFn)(void *, const char *);
        return get_v_func<CallVFunctionFn>(this, 5)(this, name);
    }

    CSchemaType *FindTypeDeclaredEnum(const char *name)
    {
        typedef CSchemaType *(__thiscall *CallVFunctionFn)(void *, const char *);
        return get_v_func<CallVFunctionFn>(this, 6)(this, name);
    }

    CSchemaClassBinding *FindRawClassBinding(const char *name)
    {
        typedef CSchemaClassBinding *(__thiscall *CallVFunctionFn)(void *, const char *);
        return get_v_func<CallVFunctionFn>(this, 7)(this, name);
    }

    CSchemaEnumBinding *FindRawEnumBinding(const char *name)
    {
        typedef CSchemaEnumBinding *(__thiscall *CallVFunctionFn)(void *, const char *);
        return get_v_func<CallVFunctionFn>(this, 8)(this, name);
    }
...
public:
    ...
    {
        typedef CSchemaSystemTypeScope *(__thiscall *CallVFunctionFn)(void *);
        return get_v_func<CallVFunctionFn>(this, 11)(this);
    }

    CSchemaSystemTypeScope *FindTypeScopeForModule(const char *m_module_name)
    {
        typedef CSchemaSystemTypeScope *(__thiscall *CallVFunctionFn)(void *, const char*);
        return get_v_func<CallVFunctionFn>(this, 13)(this, m_module_name);
    }
